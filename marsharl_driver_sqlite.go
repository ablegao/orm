...
__isnull=True/False
**/
func (self SqliteModeToSql) _w(a string) string {
	typ := ""
...
func (self SqliteModeToSql) _where() (sql string, val []interface{}) {
...
func (self SqliteModeToSql) _set() (sql string, val []interface{}) {
